        ...
        <div className={s.overlay}>
            <div className={s.drawer}>
                <h2 className={s.drawer__title}>
                    <p>Корзина</p>
                    <img onClick={onClose} src="https://saveliy2508.github.io/react-sneakers/img/cross.png" alt="cross"/>
                </h2>
                    ...
                    <div>
                        ...
                        <div className={s.drawerFooter}>
                            ...
                            <button className={s.greenButton} onClick={onClickOrder} disabled={disabled}>Оформить заказ<img
                                src='https://saveliy2508.github.io/react-sneakers/img/arrow.svg' alt='Стрелка'/></button>
                        </div>
                    </div>
                ) : (
                    <div className={s.emptyItems}>
                        <div>
                            <img className={s.emptyBox} src={madeOrder ? 'https://saveliy2508.github.io/react-sneakers/img/order.png' : 'https://saveliy2508.github.io/react-sneakers/img/imgBox.png'}
                                 alt=""/>
                            ...
                            <button onClick={onClose} className={s.greenButton}>
                                <img src="https://saveliy2508.github.io/react-sneakers/img/leftArrow.svg" alt="arrow"/>
                                Вернуться назад
                            </button>
                        </div>
                    </div>
